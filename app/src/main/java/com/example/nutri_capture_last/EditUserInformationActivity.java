...
public class EditUserInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_information_re);
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(verifyInputData()) {
                    ...
                    Toast.makeText(EditUserInformationActivity.this, "사용자 정보를 확인해주세요.", Toast.LENGTH_SHORT).show();
                }
            }
...
1
     private void renewFragment() {
            // View 갱신 (참조: https://stackoverflow.com/questions/20702333/refresh-fragment-at-reload)
            Fragment fragment = getSupportFragmentManager().findFragmentByTag("meFragment");
